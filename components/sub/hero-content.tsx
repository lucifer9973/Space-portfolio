  ...
  return (
    ...
    >
      ...
      <div className="w-full flex flex-col gap-5 justify-center m-auto text-center md:text-start">
        ...
        >
          I&apos;m an AI/ML-focused Computer Science engineer with expertise in full-stack development and scalable cloud systems. Explore my ML models, APIs, and projects.
        </motion.p>
        ...
        <motion.a
          ...
          href="#projects"
          className="py-4 px-5 sm:px-6 bg-gradient-to-r from-purple-600 to-purple-800 hover:from-purple-500 hover:to-purple-700 border-2 border-purple-500 text-white text-base sm:text-base font-medium rounded-full shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-purple-500/25 max-w-[110px] sm:max-w-[180px] mx-auto md:mx-0 flex items-center justify-center"
